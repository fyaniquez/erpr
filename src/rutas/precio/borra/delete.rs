//! src/rutas/precio/borra/delete.rs
//! author: fyaniquez
//! date: 21/10/2022
//! purpose: borra un precio
...
#[tracing::instrument(name="borra precio", skip(pool))]
#[delete("/precio/{id}")]
pub async fn procesa(
    ...
    let _row = borra(&pool, id).await
        .context("Error al borrar precio")?;
    Ok(HttpResponse::Ok().finish())
}

pub async fn borra(pool: &PgPool, id: i64) -> Result<(), sqlx::Error> {
    const DELETE: &str = "DELETE FROM precios WHERE id=$1";
