//! src/domain/cliente/documento.rs
//! author: fyaniquez
//! date: 06/12/2022
//! validaciones de un documento de cliente
...
impl Documento {
    /// Devuelve una instancia de DocumentoCliente validado
...
#[cfg(test)]
mod tests {
    use crate::domain::cliente::Documento;
