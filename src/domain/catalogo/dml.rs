...
const SELECT: &str = 
    r#"SELECT id, nombre, propietario, empresa_id, fecha, activo
    FROM catalogos WHERE empresa_id=$1"#;

// obtiene una lista de objetos
#[tracing::instrument(name = "Lista catalogos", skip(pool))]
pub async fn lista(pool: &PgPool, empresa_id: i64) -> Result<Vec<Catalogo>, sqlx::Error> {
