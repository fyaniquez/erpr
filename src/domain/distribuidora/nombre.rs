//! src/domain/distribuidora_nombre.rs
//! author: fyaniquez
//! date: 06/12/2022
//! validaciones de un nombre de distribuidora
...
impl Nombre {
    /// Devuelve una instancia de NombreDistribuidora validado
...
#[cfg(test)]
mod tests {
    use crate::domain::distribuidora::Nombre;
