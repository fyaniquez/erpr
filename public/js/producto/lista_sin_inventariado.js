...
/*
 * file: public/js/producto/lista_sin_inventariado.js
...
// responde a un click en la fila de objetos y crea un inventariado
const onClickCrea = (e) => {
    ...
    if ( pos_int >= 0 )
        ...
        path = location.href;
    var urlpath = path.replace('productos', 'inventariado');
